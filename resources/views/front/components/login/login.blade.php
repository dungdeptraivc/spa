<div class="container ">
    ...
    <div class=" bg_login mb-5">
        <div class="text-center">
            ...
            <p>Bạn chưa có tài khoản <a href="" class="text-decoration-none"> Đăng kí ngay </a></p>
            ...
            <p class="mt-2">Bạn quên mật khẩu <a href="" class="text-decoration-none "> Nhấn vào đây </a></p>
            <div class="mb-3">
