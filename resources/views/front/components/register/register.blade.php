<div class="container ">
    <div class="text_pro  ">
        <p> Trang chủ / <span class="text-secondary"> Đăng ký </span> </p>
    </div>
    <div class=" bg_login mb-5">
        <div class="text-center">
            ...
            <input type="text" class="form-control1 mt-3 w-50" placeholder="Số điện thoại " required="">
            <input type="email" class="form-control1 w-50 mt-3" placeholder="Mật khẩu" required="">
            <div class="mb-3 mt-3">
                <a href=""><button type="button" class="btn btn-secondary mb-3">Đăng ký</button></a>
            </div>
        </div>
    </div>
</div>
